...
export const Hero = () => {
  const jsonData = {
    about_me: {
      ...
      "current-career-focus": "Angular · .NET Core · React",
    },
  };
  ...
  const formattedJsonString = jsonString
    ...
    .replace(jsonData.about_me["career-in-progress"], "___CAREER_IN_PROGRESS___")
    .replace(jsonData.about_me["current-career-focus"], "___CURRENT_CAREER_FOCUS___");
